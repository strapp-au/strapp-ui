...
class Paparazzi @JvmOverloads constructor(
  ...
  private val snapshotRootDirectory: File = File(".strapp/snaps/android"),
  private val snapshotHandler: SnapshotHandler = determineHandler(maxPercentDifference, snapshotRootDirectory),
...
//          setInt(null, compileSdkVersion)
  ...
  companion object {
    ...
    private fun determineHandler(maxPercentDifference: Double, snapshotRootDirectory: File): SnapshotHandler =
      if (isVerifying) {
        SnapshotVerifier(maxPercentDifference)
      } else {
        HtmlReportWriter(snapshotRootDirectory = snapshotRootDirectory)
      }
  }
}
